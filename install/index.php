...
<nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        <span class="navbar-brand">偏执个人页面程序安装</span>
      </div><!-- /.navbar-header -->
    </div><!-- /.container -->
  </nav><!-- /.navbar -->
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<?php if($installed){ ?>
		<div class="alert alert-warning">您已经安装过，如需重新安装请删除<font color=red> install/install.lock </font>文件后再安装！ 作者QQ1544479354</div>
		<?php }else{?>
		<p align="center"><a class="btn btn-success" href="index.php?do=1" >开始安装</a></p>
		<?php }?>
	</div>
</div>
...
<p><span><a class="btn btn-success" href="index.php?do=0"><<上一步</a></span>
<span style="float:right"><a class="btn btn-success" href="index.php?do=2" align="right">下一步>></a></span></p>
</div>
...
echo <<<HTML
		...
		<br><input type="submit" class="btn btn-success btn-block" name="submit" value="保存配置">
		</form><br/>
...
?>";
		if(!$con=DB::connect($db_host,$db_user,$db_pwd,$db_name,$db_port)){
			...
			echo '<div class="alert alert-success">数据库配置文件保存成功！</div>';
			if(DB::query("select * from yaofan_config where 1")==FALSE)
				echo '<p align="right"><a class="btn btn-success btn-block" href="?do=4">创建数据表>></a></p>';
			else
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过本程序</div>
				<div class="list-group-item">
					<a href="?do=6" class="btn btn-block btn-info">跳过安装</a>
...
if($e==0) {
	echo '<div class="alert alert-success">安装成功！<br/>SQL成功'.$t.'句/失败'.$e.'句</div><p align="right"><a class="btn btn-block btn-success" href="index.php?do=5">下一步>></a></p>';
} else {
...
<?php
	...
	echo '<div class="alert alert-info"><font color="green">安装完成！管理账号和密码是:admin/123456</font><br/><br/><a href="../">>>网站首页</a>｜<a href="../admin/">>>后台管理</a><hr/>更多设置选项请登录后台管理进行修改。<br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，请自行在install/ 目录建立 install.lock 文件！如有疑问联系QQ1544479354</font></div>';
?>
	</div>
</div>
